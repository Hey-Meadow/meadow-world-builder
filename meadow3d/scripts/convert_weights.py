...
intentionally skipped per `meadow3d/docs/PORT_PLAN.md` scope cuts):
...
Usage:
    .venv/bin/python meadow3d/weights/convert.py \
...
def convert_all(ckpt_dir: str, out_dir: str, no_compress: bool = False) -> None:
    ...
    if not file_summary:
        print("[convert] no checkpoints found; nothing written. "
              "(Planning KEY_MAP.md in meadow3d/weights/ left intact.)")
        return
    ...
    with open(kmap_path, "w") as f:
        ...
        f.write("Generated by `meadow3d/weights/convert.py`.\n\n")
...
def main():
    ...
    ap.add_argument("--out", default="meadow3d/weights/sam3d_objects/", help="Output dir for npz files")
